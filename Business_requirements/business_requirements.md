...
- **Мониторинг отклонений** – Мониторинг показателй проекта (цели, сроки, бюджет, риски, ключевые события). Автоматическое выявление отклонений, подготовка карты информирования, распространение оповещений.
